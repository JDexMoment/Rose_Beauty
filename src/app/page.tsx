    ...
    <div className="bg-[#FFF8F5] text-[#1A1A1A] overflow-x-hidden">
      ...
      <section id="masters" className="max-w-[1280px] mx-auto px-4 lg:px-6 mt-14 lg:mt-20">
        ...
        <div className="mt-6 grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-6">
          {masters.map((m) => (
            <div key={m.name} className="bg-white rounded-[24px] border border-[#E8D5B7]/50 overflow-hidden group hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)] transition">
              <div className="relative aspect-[4/4.2] overflow-hidden bg-[#FDF2EE]">
              ...
              <div className="p-4 lg:p-5">
                ...
                <a
                  href="https://dikidi.ru/ru/profile/roza_128"
                  target="_blank"
                  className="mt-3 inline-flex w-full items-center justify-center gap-1.5 bg-[#FDE8E9] hover:bg-[#E8B4B8] hover:text-white rounded-full py-2.5 text-sm font-medium transition"
                >
          ...
          <div className="bg-[#1A1A1A] rounded-[28px] p-6 lg:p-8 text-white relative overflow-hidden">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 text-center">
              {[
                ...
                <div key={k} className="bg-white/10 backdrop-blur border border-white/10 rounded-2xl py-4">
